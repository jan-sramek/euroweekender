...
namespace WeekendFlights.Infrastructure.Migrations
{
    ...
    [Migration("20260912142603_AddFlightCityCodeToUtcDepartureIndex")]
    partial class AddFlightCityCodeToUtcDepartureIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeekendFlights.Domain.Entities.City", b =>
                {
                    ...
                    b.Property<Dictionary<string, string>>("NamesByLocale")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
            ...
            modelBuilder.Entity("WeekendFlights.Domain.Entities.CityWeekendCrawlState", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WeekendFlights.Domain.Entities.Flight", b =>
                {
                    ...
                    b.Property<int>("TechnicalStopsReturn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0);
                    ...
                    b.HasIndex("CityCodeTo", "UtcDeparture");
            ...
            modelBuilder.Entity("WeekendFlights.Domain.Entities.SeoPageContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<List<SeoFaqItem>>("Faq")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValueSql("'[]'::jsonb");
                    ...
                    b.HasIndex("PageType", "OriginCode", "DestinationCode", "Locale")
                        .IsUnique()
                        .HasDatabaseName("idx_seo_page_contents_lookup");

                    b.ToTable("seo_page_contents", (string)null);
                });
